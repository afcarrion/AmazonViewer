 ...
 * books y magazines, Te permite generar reportes generales y fecha del día.
 * <p>
 * Existen alguna reglas para poder ejecutar este programa.
 *  
 * @author freehyoga
 * @version 1.1
 * @since 2018
...
public class Main {
	...
	public static void showMovies() {
		...
		do {
			...
			//Agregando programacion funcional
			//Generar un integer atomico 
